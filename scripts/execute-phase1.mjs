...
const migration1File = path.join(migrationDir, '20260822021251_6d2b278a-9cbd-46b8-b007-d38a54d0df2f.sql');
const migration2File = path.join(migrationDir, '20260822021259_91a717e7-d94a-4ace-b0be-9f207bec227a.sql');
  ...
  try {
    ...
    const response = await fetch(`${SUPABASE_URL}/rest/v1/rpc/sql`, {
      ...
      headers: {
        ...
        'apikey': process.env.SUPABASE_PUBLISHABLE_KEY || 'sb_publishable_X0o9HN0EAjBJpcInCi-iWw_Tle3mcyk',
