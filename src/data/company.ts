export const company = {
  name: "floristeria lucia",
  tagline: "Flores · Plantas · Emociones",
  legalName: "floristeria lucia",
  address: "Calle de Motrico 9, 28830 San Fernando de Henares, Madrid",
  phone: "919 95 38 80",
  phoneRaw: "919953880",
  phoneLink: "+34919953880",
...
export const legalNotices = [
  ...
  },
  {
    ...
    body: `Dispones de un plazo máximo de 24 horas desde la recepción del pedido para notificar cualquier incidencia o daño de transporte visible. Escríbenos a ${company.email} o llámanos al ${company.phone} adjuntando fotografías del producto recibido para poder gestionar la solución lo antes posible.`,
  },
  {
    id: "desistimiento",
