...
export function AnimatedFlowerHero() {
  ...
  const content = (
    <div
      ...
      style={{ transitionDuration: `${TEXT_TRANSITION_MS}ms`, transitionTimingFunction: "cubic-bezier(0.22, 1, 0.36, 1)" }}
    >
      <p
        className={cn(itemClass, phase === "entering" ? "opacity-0 translate-y-2" : "opacity-100 translate-y-0")}
      ...
      >
        ...
        <Button asChild size="lg" variant="outline" className="btn-micro h-12 hover:border-primary/50 hover:shadow-soft">
