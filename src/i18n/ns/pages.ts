    ...
    shipping: {
      ...
      rateRows: {
        "san-fernando": {
          ...
          conditions: ["Pedido mínimo: 25 €", "Pedidos superiores a 35 €"],
          results: ["+6 € de portes", "Envío gratuito"],
        },
        limitrofes: {
          name: "Pueblos Limítrofes",
          sub: "Torrejón de Ardoz, Coslada",
          conditions: ["Pedido mínimo: 25 €", "Pedidos superiores a 55 €"],
          results: ["+11 € de portes", "Envío gratuito"],
        },
        cercanas: {
          name: "Otras Localidades",
          sub: "Paracuellos de Jarama, Alcalá de Henares, Mejorada del Campo, Vicálvaro, Parque Corredor",
          conditions: ["Pedido mínimo: 25 €", "Pedidos superiores a 55 €"],
          results: ["+16 € de portes", "Envío gratuito"],
        },
        madrid: {
          name: "Madrid Capital",
          sub: "Entrega con reparto propio.",
          conditions: ["Pedido mínimo: 25 €", "Pedidos superiores a 120 €"],
          results: ["+20 € de portes", "Envío gratuito"],
        },
      },
      generalItems: {
