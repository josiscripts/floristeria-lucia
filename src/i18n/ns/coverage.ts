...
export const coverage: LocaleBundle = {
  es: {
    ...
    noResults: "No entregamos con reparto propio en esa población. Llámanos y buscamos una solución.",
  ...
  en: {
    ...
    noResults: "We don't deliver with our own fleet to that town. Call us and we'll find a solution.",
  ...
  ca: {
    ...
    noResults: "No fem lliurament amb repartiment propi en aquesta població. Truca'ns i buscarem una solució.",
